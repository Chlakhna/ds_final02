...
# Collect user inputs
area = st.slider("Area", min_value=0.0, max_value=254616.0, step=0.1)
perimeter = st.slider("Perimeter", min_value=0.0, max_value=2000.0, step=0.1)
major_axis_length = st.slider("Major Axis Length", min_value=0.0, max_value=800.0, step=0.1)
...
convex_area = st.slider("Convex Area", min_value=0.0, max_value=263261.0, step=0.1)
equiv_diameter = st.slider("Equiv Diameter", min_value=0.0, max_value=600.0, step=0.1)
